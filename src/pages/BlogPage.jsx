...
const blogPosts = [
  {
    ...
    excerpt:
      "Discover practical advice to strengthen your relationships and create deeper connections with those around you.",
  ...
  },
  {
    ...
    excerpt:
      "Learn powerful strategies to resolve conflicts peacefully and improve communication in all your relationships.",
  ...
  },
  {
    ...
    excerpt:
      "Understand why self-love is the foundation of healthy relationships and how to cultivate it daily.",
  ...
  },
  {
    ...
    excerpt:
      "Improve your communication to foster better connections and understanding in every interaction.",
  ...
  },
  {
    ...
    excerpt:
      "Explore practical tips to make long-distance relationships thrive despite the physical distance.",
  ...
  },
  {
    ...
    excerpt:
      "Learn the essential steps to rebuild trust and create a stronger foundation after challenges.",
  ...
  },
  {
    ...
    excerpt:
      "Discover the five love languages and practical ways to express love in meaningful ways.",
  ...
  },
  {
    ...
    excerpt:
      "Prioritize self-care to improve your emotional availability and connection with others.",
  ...
  },
  {
    ...
    excerpt:
      "Learn how to end a relationship with mutual respect, understanding, and compassion.",
...
const BlogPage = () => {
  ...
  const handleViewAndOpen = async (post) => {
    if (userId) {
      ...
      try {
        const res = await fetch(
          API_BASE + "/api/blog/" + post.id + "/view",
          {
            method: "POST",
            headers: {
  ...
  const loadDiscussion = async (postId) => {
    ...
    try {
      const res = await fetch(
        API_BASE + "/api/blog/" + postId + "/discussions"
      );
  ...
  const handleNewsletterSubmit = async (e) => {
    ...
    try {
      ...
      setNewsletterMessage({
        type: "error",
        text:
          "Unable to connect. Please ensure the backend is running and try again."
      });
    } finally {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-purple-50 dark:from-gray-950 dark:via-gray-900 dark:to-purple-950/40 py-10 px-4 relative overflow-hidden transition-colors duration-300">

      {/* Background Decorative Elements */}

      <motion.div
        className="absolute top-0 left-0 w-64 h-64 bg-pink-200 dark:bg-pink-900/30 rounded-full mix-blend-multiply dark:mix-blend-normal filter blur-3xl opacity-20 dark:opacity-30 animate-blob"
        animate={{
          x: [0, 100, 0],
          y: [0, 50, 0]
        }}
      ...
      <motion.div
        className="absolute bottom-0 right-0 w-96 h-96 bg-purple-200 dark:bg-purple-900/30 rounded-full mix-blend-multiply dark:mix-blend-normal filter blur-3xl opacity-20 dark:opacity-30 animate-blob"
        animate={{
          x: [0, -100, 0],
          y: [0, -50, 0]
        }}
      ...
      <motion.div
        className="absolute top-1/2 left-1/3 w-48 h-48 bg-blue-200 dark:bg-blue-900/20 rounded-full mix-blend-multiply dark:mix-blend-normal filter blur-3xl opacity-20 dark:opacity-30 animate-blob"
        animate={{
          x: [0, 80, 0],
          y: [0, -80, 0]
        }}
      ...
      >
        ...
        >
          Cultivate meaningful relationships through
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8">
          ...
          >
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 rounded-2xl border-2 border-gray-200 dark:border-gray-700 focus:border-pink-500 focus:outline-none shadow-lg bg-white/80 dark:bg-gray-900/80 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 backdrop-blur-sm transition-colors"
              value={searchTerm}
              onChange={(e) =>
              ...
              <motion.button
                ...
                className={`px-6 py-3 rounded-xl font-medium capitalize whitespace-nowrap transition-all ${
                  activeFilter === filter
                    ...
                    : "bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 border-2 border-gray-200 dark:border-gray-700 hover:bg-pink-50 dark:hover:bg-gray-700"
                }`}
                onClick={() =>
      ...
      >
        <AnimatePresence>
          {filteredPosts.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch" style={{ gridAutoRows: "1fr" }}>
              ...
              {filteredPosts.map((post) => (
                ...
                >
                  ...
                  <div
                    className={`relative h-48 bg-gradient-to-br ${post.color} p-6`}
                  >
                    {post.featured && (
                      <motion.div
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                      {post.tags.map((tag, idx) => (
                        <motion.span
                          key={idx}
                          className="px-3 py-1 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-full text-sm border border-transparent dark:border-gray-700"
                          whileHover={{
                            scale: 1.1
                          }}
                        >
                    ...
                    <div className="mt-auto flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-800">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <motion.button
                          className="flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 cursor-pointer transition-colors"
                          whileHover={{
                            scale: 1.1,
                            x: 5
                          }}
                      ...
                      <motion.a
                        ...
                        onClick={(e) => {
                          e.preventDefault();
                          handleViewAndOpen(post);
                        }}
                        className="group inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-full font-medium shadow-md hover:shadow-lg"
                        whileHover={{
                          scale: 1.05,
                          gap: 4
                        }}
                    ...
                    {openDiscussionPostId === post.id && (
                      <div className="mt-4 p-4 bg-pink-50 dark:bg-gray-800/80 rounded-xl border border-pink-100 dark:border-gray-700">
                          ...
                          {discussionLoading[post.id] ? (
                            ...
                            (discussionsByPost[post.id] || [])
                              ...
                              (
                                ...
                                <div
                                  key={item.id}
                                  className="bg-white dark:bg-gray-900 border border-pink-100 dark:border-gray-700 rounded-lg p-2"
                                >
                        ...
                        <div className="mt-3 flex gap-2">
                          ...
                          <input
                            type="text"
                            value={
                              discussionInputByPost[
                                post.id
                              ] || ""
                            }
                            onChange={(e) =>
                              setDiscussionInputByPost(
                                (prev) => ({
                                  ...prev,
                                  [post.id]:
                                    e.target.value
                            ...
                            className="flex-1 px-3 py-2 rounded-lg border border-pink-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 text-sm focus:outline-none focus:border-pink-500"
            ...
            >
              <IoMdFlower className="text-8xl text-gray-300 dark:text-gray-700 mx-auto mb-6" />
      ...
      >
        <div className="bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 rounded-3xl p-8 md:p-12 text-center text-white relative overflow-hidden shadow-xl dark:shadow-black/40">
          ...
          <p className="text-lg mb-8 opacity-90">
            Get weekly relationship insights and self-care
          ...
          >
            <input
              ...
              className="flex-1 px-6 py-4 rounded-full text-gray-800 dark:text-gray-900 bg-white focus:outline-none focus:ring-2 focus:ring-white/30"
            ...
            <motion.button
              type="submit"
              disabled={newsletterSubmitting}
              className="px-8 py-4 bg-white text-pink-600 font-bold rounded-full hover:bg-gray-100 disabled:opacity-70 transition-colors"
              whileHover={{
                scale: 1.05
              }}
              whileTap={{
